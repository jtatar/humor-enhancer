...
class Profile extends Component{
    ...
    render(){
        const {user, route, jokes, delFavouriteById, myProfile} = this.props;
                        ...
                        <div>
                            {
                                jokes?
                                    ...
                                    jokes.map((joke) => {
                                        return(
                                            <Joke key={`jokeid${joke.id}`} joke={joke} userid={user.id} delFavouriteById={delFavouriteById} route={route} myProfile={myProfile}/>
                                        );
                                    })
